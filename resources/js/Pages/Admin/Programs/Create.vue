<template>
    <AdminLayout :page-title="t('programs.create') || 'Create Program'">
        <Head :title="t('programs.create') || 'Create Program'" />
            ...
            <div class="mb-4">
                <nav aria-label="breadcrumb" class="mb-3">
                    <ol class="breadcrumb mb-2">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ t('programs.create') || 'Create Program' }}</li>
                    </ol>
                </nav>
                <h1 class="h2 fw-bold mb-2">{{ t('programs.create') || 'Create Program' }}</h1>
            </div>
