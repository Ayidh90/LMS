<template>
    <AdminLayout :page-title="t('tracks.edit') || 'Edit Track'">
        <Head :title="t('tracks.edit') || 'Edit Track'" />
            ...
            <div class="mb-4">
                <nav aria-label="breadcrumb" class="mb-3">
                    <ol class="breadcrumb mb-2">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ t('tracks.edit') || 'Edit Track' }}</li>
                    </ol>
                </nav>
                <h1 class="h2 fw-bold mb-2">{{ t('tracks.edit') || 'Edit Track' }}</h1>
            </div>
...
const form = useForm({
    program_id: props.track.program_id || null,
    name: props.track.name || '',
    name_ar: props.track.name_ar || '',
    description: props.track.description || '',
    description_ar: props.track.description_ar || '',
    order: props.track.order || 0,
    is_active: props.track.is_active ?? true,
});

const submit = () => {
    form.put(route('admin.tracks.update', props.track.slug || props.track.id), {
        preserveScroll: true,
        onSuccess: () => {
