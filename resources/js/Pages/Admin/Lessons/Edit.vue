<template>
    <AdminLayout :page-title="t('admin.edit_lesson') || 'Edit Lesson'">
        <Head :title="t('admin.edit_lesson') || 'Edit Lesson'" />
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-500">{{ lesson.translated_title || lesson.title }}</p>
            </div>
