<template>
  ...
  >
    ...
    <div
      class="admin-course-show-page container-fluid px-3 px-md-4 px-lg-5 py-4"
      :dir="direction"
    >
      <!-- Page Header - Enhanced -->
      <div
        class="flex flex-col sm:flex-row sm:items-center gap-4 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 rounded-2xl p-8 shadow-2xl relative overflow-hidden mb-6"
      >
        <div class="absolute inset-0 bg-black/5"></div>
        <div
          class="absolute top-0 right-0 w-96 h-96 bg-white/5 rounded-full -mr-48 -mt-48 blur-3xl"
        ></div>
        <div class="relative z-10 order-2 sm:order-1">
          ...
          >
            ...
            <span>{{
              t("admin.edit_course") || t("common.edit") || "Edit Course"
            }}</span>
          </Link>
        </div>
        <div
          class="relative z-10 text-white flex-1 text-right order-1 sm:order-2"
          :class="direction === 'rtl' ? 'text-left' : 'text-right'"
        >
          <div
            class="flex items-center gap-2 text-sm text-blue-100 mb-3 justify-end"
            :class="
              direction === 'rtl'
          ...
          >
            <Link
              ...
              >{{ t("admin.courses_management") || "Courses Management" }}</Link
            >
          ...
          <h1
            class="text-4xl font-bold mb-3 flex items-center gap-3 justify-end"
            :class="
              direction === 'rtl'
                ? 'flex-row-reverse justify-start'
                : 'justify-end'
          ...
          <p
            class="text-blue-100 text-base flex items-center gap-2"
            :class="direction === 'rtl' ? 'justify-start' : 'justify-end'"
          >
            <i class="bi bi-info-circle"></i>
            {{
              t("admin.course_full_details") ||
              "View complete course information and statistics"
            }}
          </p>
        </div>
      </div>
          ...
          <div class="card border-0 shadow-sm h-100 stat-card-hover">
            <div class="card-body">
              ...
              <small class="text-muted fw-semibold d-block">{{
                t("admin.total_students") || "Total Students"
              }}</small>
            </div>
          </div>
        </div>
        <div class="col-6 col-md-4 col-lg-3 col-xl-2">
          <div class="card border-0 shadow-sm h-100 stat-card-hover">
            <div class="card-body">
              ...
              <small class="text-muted fw-semibold d-block">{{
                t("admin.total_enrollments") || "Total Enrollments"
              }}</small>
            </div>
          </div>
        </div>
        <div class="col-6 col-md-4 col-lg-3 col-xl-2">
          <div class="card border-0 shadow-sm h-100 stat-card-hover">
            <div class="card-body">
              ...
              <h3 class="h2 fw-bold text-info mb-1">
                {{ statistics?.total_lessons || 0 }}
              </h3>
              <small class="text-muted fw-semibold d-block">{{
                t("admin.total_lessons") || "Total Lessons"
              }}</small>
            </div>
          </div>
        </div>
        <div class="col-6 col-md-4 col-lg-3 col-xl-2">
          <div class="card border-0 shadow-sm h-100 stat-card-hover">
            <div class="card-body">
              ...
              <small class="text-muted fw-semibold d-block">{{
                t("admin.total_batches") || "Total Batches"
              }}</small>
            </div>
          </div>
        </div>
        <div class="col-6 col-md-4 col-lg-3 col-xl-2">
          <div class="card border-0 shadow-sm h-100 stat-card-hover">
            <div class="card-body">
              ...
              <h3 class="h2 fw-bold text-danger mb-1">
                {{ statistics?.total_questions || 0 }}
              </h3>
              <small class="text-muted fw-semibold d-block">{{
                t("admin.total_questions") || "Total Questions"
              }}</small>
            </div>
          </div>
        </div>
        <div class="col-6 col-md-4 col-lg-3 col-xl-2">
          <div class="card border-0 shadow-sm h-100 stat-card-hover">
            <div class="card-body">
              ...
              <small class="text-muted fw-semibold d-block">{{
                t("admin.completion_rate") || "Completion Rate"
              }}</small>
            </div>
          </div>
        </div>
      ...
      <div
        v-if="
          statistics?.lesson_completion_stats &&
          statistics.lesson_completion_stats.length > 0
        "
        class="row g-4 mb-4"
      >
        <div class="col-12">
          <div class="card shadow-sm border-0">
            ...
            >
              <h5 class="mb-0">
                ...
                {{
                  t("admin.lesson_completion_statistics") ||
                  "Lesson Completion Statistics"
                }}
              </h5>
              <i
                class="bi"
                :class="
                  isLessonStatsCollapsed ? 'bi-chevron-down' : 'bi-chevron-up'
                "
                ...
                <table class="table table-hover">
                  <thead>
                    <tr>
                      ...
                      <th>
                        {{
                          t("admin.completed_lessons") || "Completed Lessons"
                        }}
                      </th>
                  ...
                  <tbody>
                    <tr
                      v-for="stat in statistics.lesson_completion_stats"
                      :key="stat.student_id"
                    >
                      <td>
                      ...
                      <td>
                        ...
                        >
                          <div
                            ...
                            :style="{
                              width: getProgressWidth(stat.progress_percentage),
                            }"
                            role="progressbar"
                            :aria-valuenow="
                              getProgressPercentage(stat.progress_percentage)
                            "
                            aria-valuemin="0"
                            aria-valuemax="100"
                          >
          ...
          <div class="card shadow-sm mb-4">
            <div class="card-header bg-white">
              <h3 class="h5 fw-bold mb-0">
                {{ t("admin.course_details") || "Course Details" }}
              </h3>
            </div>
            <div class="card-body">
              <div class="row g-4">
                <div class="col-12">
                  <label class="form-label text-muted small fw-semibold"
                    >{{ t("courses.fields.title") || "Title" }} ({{
                      t("common.language_english") || "English"
                    }})</label
                  >
                ...
                <div v-if="course?.title_ar" class="col-12">
                  <label class="form-label text-muted small fw-semibold"
                    >{{ t("courses.fields.title") || "Title" }} ({{
                      t("common.language_arabic") || "Arabic"
                    }})</label
                  >
                  <p class="mb-0 fw-semibold" dir="rtl">
                    {{ course?.title_ar }}
                  </p>
                </div>
                ...
                >
                  <label class="form-label text-muted small fw-semibold"
                    >{{ t("courses.fields.title") || "Title" }} ({{
                      t("common.current_language") || "Current Language"
                    }})</label
                  >
                  <p class="mb-0 fw-semibold" :dir="direction">
                    {{ course?.translated_title }}
                  </p>
                </div>
                ...
                <div class="col-12">
                  <label class="form-label text-muted small fw-semibold"
                    >{{ t("courses.fields.description") || "Description" }} ({{
                      t("common.language_english") || "English"
                    }})</label
                  >
                ...
                >
                  ...
                  >
                  <p class="mb-0 text-muted" :dir="direction">
                    {{ course?.translated_description }}
                  </p>
                </div>
                ...
                <div class="col-12 col-md-6">
                  <label class="form-label text-muted small fw-semibold">{{
                    t("courses.fields.duration_hours") || "Duration"
                  }}</label>
            ...
            >
              <div>
                ...
                <p class="text-muted small mb-0">
                  {{
                    t("admin.course_content_description") ||
                    "Manage sections, lessons, and questions"
                  }}
                </p>
              </div>
              <Link
                  ...
                  >
                    <h2 class="accordion-header" :id="`heading-${section.id}`">
                      <div class="d-flex align-items-center w-100 pe-3">
                        <button
                          ...
                          :aria-expanded="
                            isSectionExpanded(section.id) ? 'true' : 'false'
                          "
                    ...
                    >
                      <div class="accordion-body">
                        ...
                        <div
                          v-if="section.lessons && section.lessons.length > 0"
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <div
                                class="bg-primary bg-gradient rounded p-2 flex-shrink-0"
                              >
                              ...
                              >
                                ...
                                <Link
                                  ...
                                  :href="
                                    route(
                                      'admin.courses.lessons.questions.index',
                                      [course.slug || course.id, lesson.id]
                                    )
                                  "
                                  class="btn btn-sm lesson-action-btn-view"
                                  :title="
                                    t('admin.view_questions') ||
                                    'View Questions'
                                  "
                                  @click.stop
                                >
                                ...
                                <span
                                  v-if="
                                    ...
                                    lesson.questions.length > 0
                                  "
                                  class="badge bg-info align-self-center"
                                >
                            ...
                            >
                              ...
                              >
                                <i
                                  class="bi bi-circle-fill text-primary flex-shrink-0 mt-1"
                                ...
                                <button
                                  ...
                                  :title="
                                    t('admin.edit_question') || 'Edit Question'
                                  "
                                >
                                  <i class="bi bi-pencil"></i>
                                </button>
        ...
        <div class="col-12 col-lg-4">
          ...
          <div class="card shadow-sm mb-4">
            <div class="card-header bg-light">
              ...
              <p class="text-muted small mb-0">
                {{
                  t("admin.manage_course_content_description") ||
            ...
            >
              ...
              <div class="d-flex gap-2">
                <Link
                  ...
                  :title="t('admin.manage_batches') || 'Manage Batches'"
                >
                  <i class="bi bi-list me-1"></i>
                  <span class="d-none d-sm-inline">{{
                    t("admin.manage_batches") || "Manage"
                  }}</span>
                </Link>
                <button
                  @click="openBatchModal()"
            ...
            <div class="card-body">
              ...
              >
                <Link
                  ...
                  :key="batch.id"
                  :href="
                    route('admin.courses.batches.show', [
                      course.slug || course.id,
                      batch.id,
                    ])
                  "
                ...
                >
                  ...
                  >
                    <div class="flex-grow-1">
                      ...
                      <div
                        class="d-flex align-items-center justify-content-between gap-2 text-muted small"
                      >
                        <div class="d-flex align-items-center gap-1">
                          <i class="bi bi-person"></i>
                          <span
                            >{{ t("admin.instructor") || "Instructor" }}:
                            <strong>{{
                        ...
                        <div
                          v-if="batch.enrollments_count !== undefined"
                  ...
                  <div
                    ...
                    class="text-muted small mt-2 d-flex align-items-center gap-2"
                  >
                    <span>
...
const submitSection = (formData) => {
  ...
  if (editingSection.value) {
    sectionForm.put(
      route("admin.courses.sections.update", [
      ...
      ]),
      {
        ...
        onSuccess: () => {
          showSuccess(
            t("sections.updated_successfully") ||
    ...
    sectionForm.post(
      ...
      ),
      {
        ...
        onSuccess: () => {
          showSuccess(
            t("sections.created_successfully") ||
...
const openLessonModal = (lessonOrSectionId = null) => {
  ...
  if (
    lessonOrSectionId &&
    typeof lessonOrSectionId === "object" &&
    lessonOrSectionId.id
  ) {
    ...
    const sectionId =
      lessonOrSectionId.section?.id || lessonOrSectionId.section_id || null;
...
const submitLesson = (formData) => {
  ...
  if (isAdmin.value && (!sectionId || sectionId === null || sectionId === "")) {
    showError(
      t("lessons.validation.section_required") ||
        "Section is required for admin users. Please select a section.",
  ...
  if (
    isFileTypeLesson &&
    (lessonForm.video_file instanceof File ||
  ...
  if (lessonForm.type === "live") {
    ...
    if (
      lessonForm.live_meeting_date &&
      lessonForm.live_meeting_date.trim() !== ""
    ) {
  ...
  if (
    ...
    lessonForm.duration_minutes === undefined
  ) {
    lessonForm.duration_minutes = 0;
  } else {
  ...
  if (editingLesson.value) {
    ...
    lessonForm
      ...
      .put(
        route("admin.courses.lessons.update", [
          props.course.slug || props.course.id,
        ...
        ]),
        {
          ...
          onSuccess: () => {
            showSuccess(
              t("lessons.updated_successfully") ||
    ...
    lessonForm
      ...
      .post(
        ...
        ),
        {
          ...
          onSuccess: () => {
            showSuccess(
              t("lessons.created_successfully") ||
...
const openQuestionModal = (lessonId, question = null) => {
  ...
  if (question) {
    ...
    questionForm.question =
      question.translated_question || question.question || "";
    questionForm.question_ar = question.question_ar || "";
    questionForm.explanation =
      question.translated_explanation || question.explanation || "";
...
const submitQuestion = (formData) => {
  ...
  if (editingQuestion.value) {
    ...
    questionForm.put(
      route("admin.courses.lessons.questions.update", [
        props.course.slug || props.course.id,
      ...
      ]),
      {
        ...
        onSuccess: () => {
          showSuccess(
            t("questions.updated_successfully") ||
    ...
    // Create new question
    questionForm.post(
      route("admin.courses.lessons.questions.store", [
        props.course.slug || props.course.id,
        selectedLessonIdForQuestion.value,
      ]),
      {
        ...
        onSuccess: () => {
          showSuccess(
            t("questions.created_successfully") ||
  ...
  if (batch) {
    ...
    if (props.existingBatch) {
      ...
      const errorMessage = (
        ...
        "Cannot create a new batch. The previous batch (:batch_name) has not ended yet. Please wait until :end_date before creating a new one."
      )
        .replace(":batch_name", props.existingBatch.name || "")
        .replace(":end_date", endDate);
      showError(errorMessage, t("common.warning") || "Warning");
    }
  }
...
const submitBatch = (formData) => {
  ...
  if (editingBatch.value) {
    batchForm.put(
      route("admin.courses.batches.update", [
        props.course.slug || props.course.id,
      ...
      ]),
      {
        ...
        onSuccess: () => {
          showSuccess(
            t("admin.batch_updated_successfully") ||
    ...
    batchForm.post(
      ...
      ),
      {
        ...
        onSuccess: () => {
          showSuccess(
            t("admin.batch_created_successfully") ||
  ...
  nextTick(() => {
    ...
    if (window.bootstrap && window.bootstrap.Alert) {
      ...
      alertElements.forEach((alert) => {
        const closeButtons = alert.querySelectorAll(
